...
//				                                .setNamingStrategy(new MyNamingStrategy())
	...
	public static void getEmployeesEarning(Session session, double minSalary) {
		...
		Query query = session
				.createQuery("from Employee e where e.dosh >= :minSalary");
		...
		while (iter.hasNext()) {
			...
			System.out.println("\t" + e.getName() + "\t" + e.getDosh());
		}
	...
	public static void getEmployeeProjections(Session session) {
		...
		String sql = "select e.name, e.dosh from Employee e";
	...
	public static void getEmployeeSummaries(Session session) {
		...
		String sql = "select new mypackage.EmployeeSummary(e.name, e.dosh) from Employee e";
		Query query = session.createQuery(sql);
